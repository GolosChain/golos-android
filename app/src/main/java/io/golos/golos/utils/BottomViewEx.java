 ...
 */
public class BottomViewEx extends BottomNavigationView {
    // used for animation
    ...
    public BottomViewEx(Context context) {
        super(context);
    }

    public BottomViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BottomViewEx(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param visibility
     */
    public BottomViewEx setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     * @param visibility
     */
    public BottomViewEx setTextVisibility(boolean visibility) {
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    public BottomViewEx enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
     ...
     */
    @Deprecated
    public BottomViewEx enableShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    @Deprecated
    public BottomViewEx enableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    public BottomViewEx setCurrentItem(int index) {
     ...
     * @param sp
     */
    public BottomViewEx setSmallTextSize(float sp) {
     ...
     * @param sp
     */
    public BottomViewEx setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param sp
     */
    public BottomViewEx setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     * @param height   in dp
     */
    public BottomViewEx setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public BottomViewEx setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize  in dp
     */
    public BottomViewEx setIconSize(float dpSize) {
     ...
     * @param height in px
     */
    public BottomViewEx setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    public BottomViewEx setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @attr ref android.R.styleable#TextView_typeface
     */
    public BottomViewEx setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     */
    public BottomViewEx setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link BottomViewEx} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomViewEx> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomViewEx bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomViewEx bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomViewEx bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    public BottomViewEx enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    public BottomViewEx setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    public BottomViewEx setIconTintList(int position, ColorStateList tint) {
        getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    public BottomViewEx setTextTintList(int position, ColorStateList tint) {
     ...
     */
    public BottomViewEx setIconsMarginTop(int marginTop) {
     ...
     * @param marginTop in px
     */
    public BottomViewEx setIconMarginTop(int position, int marginTop) {
        /*
