...
import io.golos.golos.utils.MatchResult;
    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url) {
                if (!(GolosLinkMatcher.INSTANCE.match(url) instanceof NoMatch)) {
            ...
            public void onLoadResource(WebView view, String url) {
                ...
                MatchResult result = GolosLinkMatcher.INSTANCE.match(url);
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                if (mProgressListener != null) mProgressListener.onProgress(newProgress);
