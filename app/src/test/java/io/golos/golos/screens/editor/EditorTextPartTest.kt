...
class EditorTextPartTest {
    ...
    fun getMarkdownRepresentation() {
        var textPart = EditorTextPart(text = "![dancing-banana.gif](https://images.golos.io/DQmZ12Qr5ezJBXuJSRR1cnRuEQeMrnnBBGU721cQX893afK/dancing-banana.gif)\n" +
                "(https://golos.io/submit.html)\n" +
                "<script>\n" +
                "  // JavaScript code here\n" +
                "</script>", pointerPosition =  null);
        assert(!textPart.markdownRepresentation.contains("<script>"))

        textPart = EditorTextPart(text = "![dancing-banana.gif](https://images.golos.io/DQmZ12Qr5ezJBXuJSRR1cnRuEQeMrnnBBGU721cQX893afK/dancing-banana.gif)\n" +
